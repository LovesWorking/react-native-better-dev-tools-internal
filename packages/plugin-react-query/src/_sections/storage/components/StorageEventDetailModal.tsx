    ...
    if (type === 'boolean') {
      ...
      return (
        <View style={styles.booleanContainer}>
          <View style={[styles.booleanBadge, isTrue ? styles.trueBadge : styles.falseBadge]}>
            <Text style={[styles.booleanText, isTrue ? styles.trueText : styles.falseText]}>
              {isTrue ? 'TRUE' : 'FALSE'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <View style={styles.row}>
              ...
              <View style={[styles.actionBadge, { backgroundColor: `${getActionColor(latestEvent.action)}20` }]}>
                <Text style={[styles.actionText, { color: getActionColor(latestEvent.action) }]}>
                  {latestEvent.action}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.breakdownList}>
              <View style={styles.breakdownItem}>
                <View style={styles.breakdownItemRow}>
                  <View style={styles.breakdownItemLeft}>
                    <View style={[styles.breakdownIcon, { backgroundColor: "rgba(255, 255, 255, 0.05)" }]}>
                      <Database size={14} color="#E5E7EB" />
                    </View>
                    <View style={styles.breakdownItemInfo}>
                      <Text style={styles.breakdownItemLabel}>Total Operations</Text>
                      <Text style={styles.breakdownItemDesc}>All storage operations</Text>
                    </View>
                  </View>
                  <View style={styles.breakdownItemRight}>
                    <Text style={styles.breakdownCount}>{keyStats.totalOperations}</Text>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.breakdownItem}>
                  <View style={styles.breakdownItemRow}>
                    <View style={styles.breakdownItemLeft}>
                      ...
                      <View style={styles.breakdownItemInfo}>
                        <Text style={styles.breakdownItemLabel}>Set Operations</Text>
                        <Text style={styles.breakdownItemDesc}>Value assignments</Text>
                      </View>
                    </View>
                    <View style={styles.breakdownItemRight}>
                      <Text style={[styles.breakdownCount, { color: "#10B981" }]}>{keyStats.setCount}</Text>
                      <Text style={styles.breakdownPercentage}>
                        {((keyStats.setCount / keyStats.totalOperations) * 100).toFixed(1)}%
                      </Text>
                    </View>
                  </View>
                </View>
              ...
              {keyStats.removeCount > 0 && (
                <View style={styles.breakdownItem}>
                  <View style={styles.breakdownItemRow}>
                    <View style={styles.breakdownItemLeft}>
                      <View style={[styles.breakdownIcon, { backgroundColor: "rgba(239, 68, 68, 0.1)" }]}>
                        <XCircle size={14} color="#EF4444" />
                      </View>
                      <View style={styles.breakdownItemInfo}>
                        <Text style={styles.breakdownItemLabel}>Remove Operations</Text>
                        <Text style={styles.breakdownItemDesc}>Key deletions</Text>
                      </View>
                    </View>
                    <View style={styles.breakdownItemRight}>
                      <Text style={[styles.breakdownCount, { color: "#EF4444" }]}>{keyStats.removeCount}</Text>
                      <Text style={styles.breakdownPercentage}>
                        {((keyStats.removeCount / keyStats.totalOperations) * 100).toFixed(1)}%
                      </Text>
                    </View>
                  </View>
                </View>
                ...
                <View style={styles.breakdownItem}>
                  <View style={styles.breakdownItemRow}>
                    <View style={styles.breakdownItemLeft}>
                      ...
                      <View style={styles.breakdownItemInfo}>
                        <Text style={styles.breakdownItemLabel}>Merge Operations</Text>
                        <Text style={styles.breakdownItemDesc}>Object merges</Text>
                      </View>
                    </View>
                    <View style={styles.breakdownItemRight}>
                      <Text style={[styles.breakdownCount, { color: "#3B82F6" }]}>{keyStats.mergeCount}</Text>
                      <Text style={styles.breakdownPercentage}>
                        {((keyStats.mergeCount / keyStats.totalOperations) * 100).toFixed(1)}%
                      </Text>
                    </View>
                  </View>
                </View>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.sectionHeader}>
                ...
                <Text style={styles.sectionTitle}>Value Changes ({keyStats.valueChanges.length})</Text>
              </View>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.sectionHeader}>
                ...
                <Text style={styles.sectionTitle}>Operation History ({keyStats.history.length})</Text>
              </View>
              <View style={styles.headerActions}>
                <TouchableOpacity
                ...
                {keyStats.history.slice(0, 50).map((item, index) => (
                  <View key={index} style={styles.historyItem}>
                    <View style={styles.historyLeft}>
                      ...
                      <View style={[styles.historyBadge, { backgroundColor: `${getActionColor(item.action)}20` }]}>
                    ...
                    <View style={styles.historyValueContainer}>
                      {item.value !== undefined && (
                        typeof parseValue(item.value) === 'object' && parseValue(item.value) !== null ? (
                          <Text style={styles.historyObjectValue}>[Object]</Text>
                        ) : (
